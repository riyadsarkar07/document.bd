...
export const ASSET_LIST = [
  ...
  { name: 'arial-regular.ttf', type: 'font', desc: 'Arial Regular', path: '/assets/arial-regular.ttf' },
  { name: 'arial-bold.ttf', type: 'font', desc: 'Arial Bold', path: '/assets/arial-bold.ttf' },
